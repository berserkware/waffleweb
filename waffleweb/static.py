...
def findStatic(path: str):
    ...
    staticDir = waffleweb.currentWorkingApp.settings.get('STATIC_DIR', DEFUALT_STATIC_DIR)
...
def openStatic(file, mode='rb', buffering=-1, encoding=None, errors=None, newline=None, closefd=True, opener=None):
    ...
    staticFinder = waffleweb.currentWorkingApp.settings.get('DEFUALT_STATIC_FINDER', findStatic)
